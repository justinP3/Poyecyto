...
public class JpEstadoCivilDTO {
    ...
    // constructores
    public JpEstadoCivilDTO() {

    }

    public JpEstadoCivilDTO(Integer idJpCatalogo, Integer idJpCatalogoTipo, String nombre, String descripcion,
            String jpEstado,
